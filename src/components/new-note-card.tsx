          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="w-full flex items-center justify-center hover:opacity-80 gap-2 bg-slate-900 py-3 text-center text-sm text-slate-300 outline-none font-medium hover:text-slate-100"
              >
